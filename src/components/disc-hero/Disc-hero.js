    ...
    return (
        <div className="disc-hero-container">
            <div className="disc-hero-text">
                <h1>Explore the <span>Artistic Landscape</span>, Discover Artists' <span>Visionary</span> Work </h1>
                <p>Explore a captivating world of art and uncover endless inspiration.</p>
            </div>
            <div className="disc-hero-rectangle">
                <input className="disc-hero-button"
                    type="text"
